...
public class OpenBookView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.e("scaleX", String.format("scalxX: %f, %f, %f, %f", scaleX, coverLeft - coverLeft * scale, coverTop - coverTop * scale, scale));

        canvas.scale(scaleX, scaleY);
//        canvas.drawRect(bookRect, pageBackgroundPaint);
        if (contentChangeListener != null) {
            contentChangeListener.onContentChange(coverLeft - coverLeft * scale, coverTop - coverTop * scale, scale, scale);
        }
        camera.save();
    ...
    interface ContentChangeListener {
        void onContentChange(float x, float y, float scaleX, float scaleY);
    }
}
